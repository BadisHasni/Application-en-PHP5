...
<div class="main-container">
 ...
 <div id="chart1" style="margin-top:0px; margin-left:200px; width:600px; height:400px;"></div>
  ...
  var typeDep = <?php 
					...
					$sql="select typeDepense from depense where departement_iddepartement=1";
					$q=mysql_query($sql);
					$arr= array();
					$i=0;
					//$show='';
			  ...
			  var lcDepense = <?php 
					...
					mysql_connect("localhost","root",""); //coonexion � la base de donn�e
					mysql_select_db("gamma"); // selection  de la base de donn�e
					$sql2="select budgetDepense from depense where departement_iddepartement=1";
					$q2=mysql_query($sql2);
					$arr2= array();
					$i=0;
					//$show='';
