   ...
   <nav> 
    ...
    <ul>
          <li>
			  ...
			  <li><a href="typo_depenseDepart.php">Consulter depenses</a></li>
			  </ul>
		    ...
		    <li>
			 ...
			 <ul>
			  ...
			  <li><a href="typo_depenseDepart.php">Consulter composant</a></li>
			  </ul>
				</li>
...
$a=$r['departement_iddepartement'];
	if ($a==1)
		...
		$show .= '<tr bgcolor="white" width="160" align="center">
					<td>'.$r['iddepense'].'</td><td>'.$r['typeDepense'].'</td><td>'.$r['budgetDepense'].'</td><td>'.$r['dateDepense'].'</td><td>'.$b.'</td>
               ...
               <table>
                        <thead>
                                <tr>
										...
										<td bgcolor='#d1cfe5' width='160' align='center'><strong>Departement</strong></td>
